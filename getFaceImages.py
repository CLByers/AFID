...
print "Populating comparisons..."
getComparisons.populateComparisons() #This part takes forever if it's building from scratch. Budget for ~60 records getting logged per second.
print "Building page..."
getComparisons.makeWebData()
print "Done."
